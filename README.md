...
[![Typing SVG](https://readme-typing-svg.demolab.com?font=JetBrains+Mono&size=13&pause=1200&color=7C3AED&center=true&vCenter=true&width=500&lines=Building+real+infra+with+AWS+%C2%B7+K8s+%C2%B7+Terraform;Automating+CI%2FCD+pipelines+hands-on;Solving+Linux+challenges+on+SadServers)](https://git.io/typing-svg)
...
Cloud & DevOps Practitioner from India, focused on **cloud infrastructure, automation, and CI/CD**. I build hands-on across the DevOps lifecycle — from Linux scripting and containerization to deploying workloads on AWS with Terraform and Kubernetes.

```yaml
currently:   Learning Ansible, Kubernetes, Terraform & Jenkins
open_to:     DevOps Internship · Cloud Support · Linux Admin roles
...
![AlmaLinux](https://img.shields.io/badge/AlmaLinux-1C1C1C?style=flat-square&logo=almalinux&logoColor=white)
...
> **SadServers** — LeetCode for Linux & DevOps. Real broken servers, real fixes.
...
[![Gmail](https://img.shields.io/badge/Gmail-D14836?style=flat-square&logo=gmail&logoColor=white)](mailto:gauritambe1513@gmail.com)
[![Portfolio](https://img.shields.io/badge/Portfolio-24243e?style=flat-square&logo=github&logoColor=white)](https://github.com/gauritambe/portfolio)
...
<sub>Cloud & DevOps Practitioner · Building real infra, not just tutorials.</sub>
